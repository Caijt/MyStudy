	...
	public class Code128
        {
            ...
            /// <returns>图形</returns>
            public Bitmap GetCodeImage(string p_Text, Encode p_Code,byte width,int height)
            {
                ...
                switch (p_Code)
                {
                    ...
                    default:
                        ...
                        while (p_Text.Length != 0)
                        {
                            ...
                            if (_ValueCode.Length == 0) throw new Exception("无效的字符集!" + 
p_Text.Substring(0, 1).ToString());
                            _Text += _ValueCode;
                            _TextNumb.Add(_Temp);
                ...
                _Text += "2331112"; //结束位
                Bitmap _CodeImage = GetImage(_Text, height);
            ...
            /// <param name="p_Text">文字</param>
            /// <returns>图形</returns>
            private Bitmap GetImage(string p_Text,int height)
            {
                ...
                Bitmap _CodeImage = new Bitmap(_Width, _height);
                ...
                for (int i = 0; i != _Value.Length; i++)
                {
                    ...
                    if (!((i & 1) == 0))
                    {
                        ...
                        _Garphics.FillRectangle(Brushes.White, new Rectangle(_LenEx, 0, _ValueNumb, _height));
                    }
                    else
                    {
                        //_Pen = new Pen(Brushes.Black, _ValueNumb);
                        _Garphics.FillRectangle(Brushes.Black, new Rectangle(_LenEx, 0, _ValueNumb, _height));
                    }
            ...
            private void GetViewText(Bitmap p_Bitmap, string p_ViewText)
            {
                ...
                _Graphics.FillRectangle(Brushes.White, new Rectangle(0, _StarY, p_Bitmap.Width, (int)
_DrawSize.Height));
